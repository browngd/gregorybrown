...
<head>
    ...
    <link href="<?php echo home_url(); ?>/css/black.css" type="text/css" rel="stylesheet"  title="black">
    <link href="<?php echo home_url(); ?>/css/blue.css" type="text/css" rel="alternate stylesheet" title="blue">
<script type="text/javascript" src="<?php echo home_url(); ?>/js/styleswitcher.js"></script>
    <!--[if IE 7]>
        ...
        <div class="navbar-inner">
            ...
            <ul class="nav">
                <li <?=echoActiveClassIfRequestMatches("index")?>>
                    <a href="<?php echo home_url(); ?>/index.php" rel="tooltip" data-placement="bottom" title="Home"><i class="icon-home icon-large icon-fixed-width"></i>
                    </a>
                </li>
                <li <?=echoActiveClassIfRequestMatches("blog")?>>
                    <a href="<?php echo home_url(); ?>/blog.php" rel="tooltip" data-placement="bottom" title="Blog"><i class="icon-align-left icon-large icon-fixed-width"></i>
                    </a>
                </li>
                <li <?=echoActiveClassIfRequestMatches("resume")?>>
                    <a href="<?php echo home_url(); ?>/resume.php" rel="tooltip" data-placement="bottom" title="Resume"><i class="icon-file-alt icon-large icon-fixed-width"></i>
                    </a>
                </li>
                <li <?=echoActiveClassIfRequestMatches("portfolio")?>>
                    <a href="<?php echo home_url(); ?>/portfolio.php" rel="tooltip" data-placement="bottom" title="Portfolio"><i class="icon-picture icon-large icon-fixed-width"></i>
                    </a>
                </li>
                <li <?=echoActiveClassIfRequestMatches("contact")?>>
                    <a href="<?php echo home_url(); ?>/contact" rel="tooltip" data-placement="bottom" title="Contact"><i class="icon-envelope-alt icon-large icon-fixed-width"></i>
                    </a>
                </li>
            </ul>
